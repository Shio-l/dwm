...
static const char *fonts[]          = {"terminus", "terminus:size=14"};
...
static const char col_cyan[]        = "#42a2f5";
...
//abrir pcmanfm
static const char *filemanager[] = { "env", "GTK_THEME=Adwaita:dark", "pcmanfm", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_p,      spawn,          { .v = filemanager } },
